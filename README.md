...
Additionally, you must know your BOT_TOKEN and CHANNEL_ID for your discord server and channel you want to upload (see reference <a name="[1]">[1]</a>
 and [2] for finding those information).
